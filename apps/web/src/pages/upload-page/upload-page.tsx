  ...
  return (
    <Page>
      <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8 bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700">
          {/* File Upload Section */}
            ...
            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-600 border-dashed rounded-lg hover:border-red-600 transition-colors duration-300">
              <div className="space-y-1 text-center">
                ...
                <div className="flex text-sm text-gray-300">
                  <label htmlFor="file-upload" className="relative cursor-pointer bg-red-600 rounded-md font-medium text-white px-3 py-1 hover:bg-red-700 transition-colors duration-300 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-red-500">
                ...
                <p className="text-xs text-gray-400">MP4, MOV, or WebM up to 2GB</p>
              </div>
            </div>
            {selectedFile && (
          ...
          {isSubmitting && (
            <div className="space-y-2">
              <label className="block text-sm font-medium text-white">Upload Progress</label>
